...
def RungeKutta(func, x0, dt):
    k1 = func(x0)
    k2 = func(tree.map_structure(lambda x, y: x + 0.5 * dt * y, x0, k1))
    k3 = func(tree.map_structure(lambda x, y: x + 0.5 * dt * y, x0, k2))
    k4 = func(tree.map_structure(lambda x, y: x + dt * y, x0, k3))
